...
void buttonPushedTask(void *params)
{
  ...
  while (true)
  {
    ...
    {
      // Button de-boucing, follow the comments below
      ...
      do
      {
        vTaskDelay(20/portTICK_PERIOD_MS); // 20ms wait
      ...
      gpio_isr_handler_add(pinNumber, gpio_isr_handler, (void*)PIN_SWITCH);
    }
  }
}
...
void app_main(void)
{
  ...
  xTaskCreate(buttonPushedTask, "buttonPusdhedTask", 2048, NULL, 1, NULL);
