...
void app_main(void)
{
  ...
  ledc_channel_config_t channel = {
    ...
    .duty = 1023,       // LEDC_TIMER_10_BIT means 10bit -> 1023 ON and 1 OFF (1024 ON and 0 OFF)
    .hpoint = 0,
  };
  ...
  for (int i=0; i< 1024; i++)
  {
    ...
    // Instead of this you can use `ledc_fade_function_install()` and `ledc_set_duty_and_update()`
