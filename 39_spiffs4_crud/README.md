This project is taken from `esp/esp-idf/examples/storage/spiffs`    

Hit Cmd+P and type `>ESP-IDF:Add vscode configuration folder`   

Run `idf.py flash monitor`   

You can confirm if `partitions_example.csv` inserted the partition table correctly by running `gen_esp32part.py build/partition_table/partition-table.bin inspect_partition.csv`  
